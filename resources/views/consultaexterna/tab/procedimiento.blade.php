<form action="{{ route('procedimientosubmit')}}" method="post" id="procedimientoform" onsubmit="submitProcedimiento(); return false;">
    ...
    <input type="hidden" name="idadmisionorden" id="idadmisionorden">
         ...
         <ul class="nav nav-tabs">
            <li class="active">
                <a href="#tab1_115030" data-toggle="tab">Procedimiento</a>
            </li>
          </ul>  
          ...
          <div class="tab-content" style="max-height: 500px; overflow: scroll; overflow-x: hidden;">
            <div class="tab-pane active" id="tab1_115030">
              ...
              <div id="mensaje_alert_procedimiento"></div>
              ...
              <div class="col-md-12 text-center">
                <a href="javascript:void(0);" class="btn btn-success agregarinpus"><i class="fa fa-plus-circle" aria-hidden="true"></i></a> 
              </div>     

              <input type="hidden" name="idtipoorden" value="2">
...
$("#fechaorden").datepicker({
  ...
  function submitProcedimiento() {
     obj_funciones.inicio_ajax('10','Enviado Datos...');
     setTimeout(function(){

        var data = obj_funciones.getajaxsimple({
            url :  $('#procedimientoform').attr("action"), 
            data : $('#procedimientoform').serialize(),
        });
        
        if(data.response == true){
          $('#mensaje_alert_procedimiento').html(data.mensaje);
          obj_funciones.mostrar_div('#mensaje_alert_procedimiento');
          getmedicamento('<?php echo $admisionid; ?>');
        }else{
           $('#mensaje_alert_procedimiento').html(data.mensaje);
           obj_funciones.mostrar_div('#mensaje_alert_procedimiento');
...
function getmedicamento(id) {
     ...
     setTimeout(function(){
        var data = obj_funciones.getajaxsimple({
            ...
            data : {'admisionid': id, 'idtipoorden': 2},
        });
