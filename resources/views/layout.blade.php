...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('assets/glob/css/components.min.css') }}" rel="stylesheet" id="style_components') }}"  type="text/css" />
        <link href="{{ asset('assets/glob/css/plugins.min.css') }}" rel="stylesheet"  type="text/css" />
...
<body class="login">
    ...
    <script src="{{ asset('assets/glob/plugins/backstretch/jquery.backstretch.min.js') }}"  type="text/javascript"></script>
    <!-- END PAGE LEVEL PLUGINS -->
    ...
    var bg1 = "{{ asset('assets/pages/img/login/bg1.jpg') }}";
    var bg2 = "{{ asset('assets/pages/img/login/bg2.jpg') }}";
    var bg3 = "{{ asset('assets/pages/img/login/bg3.jpg') }}";
    </script>
