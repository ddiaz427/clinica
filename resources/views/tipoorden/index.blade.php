    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'tipoorden', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                    ...
                    <div class="portlet box default">
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($tipoorden as $f)
                                    <tr>
                                        <td class="all text-center">{{ $f->nombretipoorden }}</td>
                                        <td class="all text-center">{{ fechaseteada($f->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($f->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'tipoorden', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $f->idtipoorden))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
