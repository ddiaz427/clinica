        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombreviaingreso" value="{{ old('nombreviaingreso', (isset($viaingreso->nombreviaingreso))?$viaingreso->nombreviaingreso:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
