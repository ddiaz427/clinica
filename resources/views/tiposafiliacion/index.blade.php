    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'tipoafiliacion', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="all text-center">{{ $a->nombretipoafiliacion }}</td>
                                        <td class="all text-center">{{ fechaseteada($a->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($a->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'tipoafiliacion', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $a->idtipoafiliacion))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
