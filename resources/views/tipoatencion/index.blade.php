    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'tipoatencion', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                    ...
                    <div class="portlet box default">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($tipoatencion as $ta)
                                    <tr>
                                        <td class="all text-center">{{ $ta->nombretipoatencion }}</td>
                                        <td class="all text-center">{{ fechaseteada($ta->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($ta->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'tipoatencion', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $ta->idtipoatencion))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
