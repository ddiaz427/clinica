        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombretiposervicio" value="{{ old('nombretiposervicio', (isset($tiposervicio->nombretiposervicio))?$tiposervicio->nombretiposervicio:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
