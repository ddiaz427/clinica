    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'regimen', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                    ...
                    <div class="portlet box default">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($regimen as $r)
                                    <tr>
                                        <td class="all text-center">{{ $r->nombreregimen }}</td>
                                        <td class="all text-center">{{ fechaseteada($r->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($r->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'regimen', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $r->idregimen))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
