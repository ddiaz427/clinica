    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'gruposanguinio', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                    ...
                    <div class="portlet box default">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($gruposanguinio as $grupo)
                                    <tr>
                                        <td class="all text-center">{{ $grupo->nombregruposanguineo }}</td>
                                        <td class="all text-center">{{ fechaseteada($grupo->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($grupo->fechaultmodificacion) }}</td>
                                    <td class="desktop">
                                    @include('partials.botones_listado', array('controller' => 'gruposanguinio', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $grupo->idgruposanguineo))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
