    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'departamento', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="all text-center">{{ $d->nombredepartamento }}</td>
                                        <td class="all text-center">{{ $d->codigodepartamentodane }}</td>
                                        <td class="all text-center">{{ fechaseteada($d->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($d->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'departamento', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $d->iddepartamento))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
