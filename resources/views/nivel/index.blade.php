    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'nivel', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($nivel as $n)
                                    <tr>
                                        <td class="all text-center">{{ $n->nombrenivel }}</td>
                                        <td class="all text-center">{{ fechaseteada($n->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($n->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'nivel', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $n->idnivel))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
