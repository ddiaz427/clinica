        ...
        parserRules: {
            ...
            tags: {
                ...
                "table": {
                    ...
                    "set_attributes": {
                        'style': 'margin: auto;background: #ffffff;border-collapse: collapse;border: 1px solid #e7ecf1;width: 100%;margin-bottom: 20px;max-width: 900px;',
                    }
                },
                "thead": 1,
                "tbody": 1,
                "th": {
                    ...
                    "set_attributes": {
                        'style': 'border-top: 0;border-bottom: 0;font-size: 14px;font-weight: 600;vertical-align: bottom;border: 1px solid #e7ecf1;padding: 0 8px;text-align: center;',
                    }
                },
                "tr": {
                    "check_attributes": {
                ...
                "td": {
                    ...
                    "set_attributes": {
                        'style': 'color: #333; padding: 0 8px; vertical-align: top;font-size: 14px;border: 1px solid #e7ecf1;',
                    }
                },
                "link": {
                    "check_attributes": {
