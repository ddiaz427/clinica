    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'sexo', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="all text-center">Codigo</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="all text-center">{{ $sexo->nombresexo }}</td>
                                        <td class="all text-center">{{ $sexo->codigosexo }}</td>
                                        <td class="all text-center">{{ fechaseteada($sexo->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($sexo->fechaultmodificacion) }}</td>
                                    <td class="desktop">
                                    @include('partials.botones_listado', array('controller' => 'sexo', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $sexo->idsexo))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
