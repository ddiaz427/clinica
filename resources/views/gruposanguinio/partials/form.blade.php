        ...
        <div class="portlet-body">
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombregruposanguineo" value="{{ old('nombregruposanguineo', (isset($gruposanguinio->nombregruposanguineo))?$gruposanguinio->nombregruposanguineo:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div> 
