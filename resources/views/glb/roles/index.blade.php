    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'rol', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
								...
								<?php foreach ($roles as $rol): ?>
                                    <tr>
                                        <td class="all">{{ $rol->nombre }}</td>
                                        <td class="all">{{ $rol->estado }}</td>
                                        <td class="desktop">{{ $rol->created_by }}</td>
                                        <td class="desktop">{{ $rol->created_at }}</td>
                                        <td class="desktop">{{ $rol->updated_at }}</td>
                                        <td class="desktop text-center">
                						@include('partials.botones_listado', array('controller' => 'rol', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $rol['id']))
                                        </td>
                                    </tr>
								<?php endforeach ?>
                                </tbody>
