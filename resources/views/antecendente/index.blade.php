    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'getantecedente', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                    ...
                    <div class="portlet box default">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($antecendentes as $antecendente)
                                    <tr>
                                        <td class="all text-center">{{ $antecendente->nombreantecedente }}</td>
                                        <td class="all text-center">{{ fechaseteada($antecendente->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($antecendente->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'getantecedente', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $antecendente->idantecedente))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
