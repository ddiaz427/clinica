        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombreespecialidad" value="{{ old('nombreespecialidad', (isset($especialidad->nombreespecialidad))?$especialidad->nombreespecialidad:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
