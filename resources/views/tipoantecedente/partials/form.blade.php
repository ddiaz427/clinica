        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombretipoantecedente" value="{{ old('nombretipoantecedente', (isset($tipoantecedente->nombretipoantecedente))?$tipoantecedente->nombretipoantecedente:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
