        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombretipodiagnostico" value="{{ old('nombretipodiagnostico', (isset($tipodianostico->nombretipodiagnostico))?$tipodianostico->nombretipodiagnostico:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
