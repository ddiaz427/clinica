    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'estadocivil', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="all text-center">{{ $civil->nombreestadocivil }}</td>
                                        <td class="all text-center">{{ fechaseteada($civil->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($civil->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'estadocivil', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $civil->idestadocivil))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
