        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombrediagnosticoalt" value="{{ old('nombrediagnosticoalt', (isset($diagnosticoalt->nombrediagnosticoalt))?$diagnosticoalt->nombrediagnosticoalt:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
