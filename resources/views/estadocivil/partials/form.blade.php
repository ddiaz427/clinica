        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombreestadocivil" value="{{ old('nombreestadocivil', (isset($estadocivil->nombreestadocivil))?$estadocivil->nombreestadocivil:'') }}" class="form-control required">
                </div> 
            </div>
        </div>
    </div> 
