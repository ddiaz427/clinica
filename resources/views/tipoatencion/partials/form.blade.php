        ...
        <div class="portlet-body">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="form-group">
                    ...
                    <input type="text" name="nombretipoatencion" value="{{ old('nombretipoatencion', (isset($tipoatencion->nombretipoatencion))?$tipoatencion->nombretipoatencion:'') }}" class="form-control required">
                </div>  
            </div>
        </div>
    </div>   
