    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'origenatencion', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                    ...
                    <div class="portlet box default">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach ($origenatencion as $o)
                                    <tr>
                                        <td class="all text-center">{{ $o->nombreorigenatencion }}</td>
                                        <td class="all text-center">{{ fechaseteada($o->fechacreacion) }}</td>
                                        <td class="all text-center">{{ fechaseteada($o->fechaultmodificacion) }}</td>
                                    <td class="desktop text-center">
                                    @include('partials.botones_listado', array('controller' => 'origenatencion', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $o->idorigenatencion))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
