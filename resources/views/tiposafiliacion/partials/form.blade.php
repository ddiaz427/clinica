    ...
    <div class="row">
        <div class="portlet-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombretipoafiliacion" value="{{ old('nombretipoafiliacion', (isset($afiliacion->nombretipoafiliacion))?$afiliacion->nombretipoafiliacion:'') }}" class="form-control required">
            </div>
