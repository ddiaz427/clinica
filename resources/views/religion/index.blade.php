    ...
    <div class="container-fluid">
        ...
        <div class="page-content-inner">
            <div class="row">
                ...
                @include('partials.boton_nuevo', array('controller' => 'religion', 'ruta' => '', 'accion' => 'create'))
                </div>
                <div class="col-md-12">
                        ...
                        <?php //print_r($pacientes); ?>
                            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="datatable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="all text-center">{{ $r->nombrereligion }}</td>
                                    ...
                                    @include('partials.botones_listado', array('controller' => 'religion', 'ruta' => '', 'accion1' => 'edit', 'accion2' => 'destroy', 'id' => $r->idreligion))
                                    </td>
                                 </tr>
                                  @endforeach
                                </tbody>
